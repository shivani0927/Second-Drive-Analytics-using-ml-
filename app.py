...
def about_page():
    ...
    # st.title("Team Members")
        ...
        team_members = [
            {"name": "Jagruti Dhangar", "designation": ""},
            {"name": "Mayur Lingayat", "designation": "EDA Team Head"},
            {"name": "Rajas Gondhali", "designation": "Modelling Team Head"},
            {"name": "Mitali Girwalkar", "designation": "Streamlit Team Head"},
            {"name": "Mahadev Jadhav", "designation": "Data Cleaning Team & Documentation Head"},
            {"name": "Niket Agasgekar", "designation": "Management Head, Streamlit Team"}
        ]
